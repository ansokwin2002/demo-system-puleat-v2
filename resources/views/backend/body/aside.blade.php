<aside id="sidebar-wrapper">
    ...
    <ul class="sidebar-menu">
        ...
        <li class="{{ Route::is('new_appointment*') ? 'active' : '' }}"><a class="nav-link" href="{{ route('new_appointment') }}"><i class="fa-solid fa-calendar-check"></i> <span>New Appointment</span></a></li>
            ...
            <li class="dropdown {{ Route::is('reports.index*') ? 'active' : '' }}">
                ...
                <ul class="dropdown-menu">
                    <li class="{{ Route::is('reports.index*') ? 'active' : '' }}">
                        <a class="nav-link" href="{{ route('reports.index') }}">Patient Report</a>
                    </li>
                    <li class="{{ Route::is('report.doctor.index*') ? 'active' : '' }}">
                        <a class="nav-link" href="{{ route('report.doctor.index') }}">Doctor Report</a>
                    </li>
                </ul>
            </li>
        <!-- [report--------------------------------------------------] -->
