                                ...
                                <div class="col-12 col-md-6 col-lg-12">
                                    <div class="table-responsive">
                                        <table class="table table-bordered table-md">
                                            ...
                                            <tbody id="treatmentServiceTableBody">
                                                
                                            </tbody>
                                            <tbody>
                                                <tr>
                                                    <td colspan="7"><strong><span class="float-right">Grand Total (USD)</span></strong></td>
                                                    <td><strong id="treatment_grand_total">$ 0.00</strong></td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    ></i></span></strong></td>
                                                    <td><span id="treatment_amount_paid">$ 0.00</span></td>
                                                </tr>
                                                <tr>
                                                    <td colspan="7"><strong><span class="float-right" id="unpaid">Unpaid amount</span></strong></td>
                                                    <td><span id="treatment_amount_unpaid">$ 0.00</span></td>
                                                </tr>
                                            </tbody>
                                        </table>
                                    </div>
...
@foreach ($completedTreatmentInfo as $index => $info)
    <div class="row">
        <div class="col-12">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="flex-grow-1">
                                        <div class="input-group">
                                            ...
                                            <input type="text" disabled class="form-control datepicker" id="date_{{ $index }}" value="{{ $info['update_customer_info'][0]['start_date'] ?? '' }}">
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="flex-grow-1">
                                        <div class="input-group">
                                            ...
                                            <select class="form-control" disabled name="doctor_id_{{ $index }}" id="doctor_{{ $index }}">
                                                @foreach ($doctors as $doctor)
                                                    <option value="{{ $doctor->id }}" {{ ($info['update_customer_info'][0]['doctor'] ?? '') == $doctor->id ? 'selected' : '' }}>
                                                        {{ $doctor->name }}
                                                    </option>
                                                @endforeach
                                            </select>
                                        ...
                                        <div class="box_select_customer">
                                            <div class="card_customer">
                                                ...
                                                <select disabled id="patient-select_{{ $index }}" class="form-control select2" style="width: 100%;">
                                                        ...
                                                        @foreach ($patients as $patient)
                                                            <option value="{{ $patient->id }}" {{ ($info['update_customer_info'][0]['patient'] ?? '') == $patient->id ? 'selected' : '' }}>
                                                                {{ $patient->name }} ({{ $patient->telephone }})
                                                            </option>
                                                        @endforeach
                                                    </select>
                                            ...
                                            <div class="card_customer">
                                                ...
                                                <div class="select_customer">
                                                    <select disabled id="cashier-select_{{ $index }}" name="cashier_id_{{ $index }}" class="form-control select2" style="width: 100%;">
                                                        <option value="" disabled>Select a Cashier</option>
                                                        @foreach ($cashiers as $cashier)
                                                            <option value="{{ $cashier->id }}" {{ ($info['update_customer_info'][0]['cashier'] ?? '') == $cashier->id ? 'selected' : '' }}>
                                                                {{ $cashier->name }}
                                                            </option>
                                                        @endforeach
                                                    </select>
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="flex-grow-1">
                                        <div class="input-group">
                                            ...
                                            <input type="text" disabled name="next_appointment_date_{{ $index }}" id="next_appointment_date_{{ $index }}" class="form-control datepicker" value="{{ $info['update_customer_info'][0]['next_appointment'] ?? '' }}">
                                        </div>
                                    </div>
                                </div>
                            </div>
                                            ...
                                            <div class="card_customer">
                                                ...
                                                <div class="select_customer">
                                                    <select disabled name="type_service_{{ $index }}" id="type_service_{{ $index }}" class="form-control">
                                                        <option value="General" {{ ($info['update_customer_info'][0]['type_service'] ?? '') == 'General' ? 'selected' : '' }}>General</option>
                                                        <option value="Implant" {{ ($info['update_customer_info'][0]['type_service'] ?? '') == 'Implant' ? 'selected' : '' }}>Implant</option>
                                                        <option value="Ortho" {{ ($info['update_customer_info'][0]['type_service'] ?? '') == 'Ortho' ? 'selected' : '' }}>Ortho</option>
                                                    </select>
                                                </div>
                                            </div>
                                        </div>
