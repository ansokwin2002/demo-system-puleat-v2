            ...
            <section class="section">
                ...
                <!--[Patient_table-------------------------]-->
                    <button class="btn btn-primary"  
                        data-toggle="modal" 
                        data-target="#fire-modal-appointment-patient" ><i class="fa-solid fa-user-plus"></i> Add Patient
                    </button>
                    <div class="row mt-4">
                        <div class="col-12">
                            <div class="card p-4">
                                            ...
                                            <tbody>
                                                ...
                                                <tr class="row_list_patients">
                                                    ...
                                                    <td class="align-middle text-center patient-name">
                                                        <span class="badge badge-info">{{ $patient->name }}</span>
...
<script>
    $(document).ready(function() {
        ...
        function selectPatientFromRow(row) {
            // Find the inline edit button that contains the data attributes
