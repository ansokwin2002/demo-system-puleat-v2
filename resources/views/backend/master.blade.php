...
<!-- sidebar-mini -->
  <div id="app">
    ...
    <!-- [model_add_service-------------------------] -->
        <div class="modal fade" id="fire-modal-add-service" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
                        ...
                        <form>
                            <div class="form-group row">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="name" id="add_service_name" class="form-control" required="">
                                </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="unit" class="form-control" id="add_unit" required="">
                                </div>
                                <div class="invalid-feedback">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="price" class="form-control" id="add_price" required="">
                                </div>
                                <div class="invalid-feedback">
    ...
    $(document).ready(function() {
        ...
        // [add_service---------------------------------------------------]
            $("#add_service").on("click", function(event) {
                ...
                // Get form data
                const serviceName = $("#add_service_name").val().trim();
                const serviceUnit = $("#add_unit").val().trim();
                const servicePrice = $("#add_price").val().trim();

                // Validate
                if (!serviceName || !serviceUnit || !servicePrice) {
                    alert("Please fill all fields.");
                    return;
                }

                // Find the current max row number
                let maxRow = 0;
                $("#serviceTableBody tr").each(function() {
                ...
                const tableRow = `
                    <tr>
                        ...
                        <td style="width:120px;">
                            <input type="text" class="form-control unit" value="${serviceUnit}" inputmode="numeric" pattern="\\d*" title="Please enter a number">
                        </td>
                        <td class="price">
                            <input type="text" class="form-control price" value="${servicePrice}">
                        </td>
                        <td class="d-flex">
                            <div class="form-check form-check-lg">
                                <input class="form-check-input discount-type" type="radio" name="discount${newId}" id="discountPercent${newId}" checked>
                                <label class="form-check-label mr-4" for="discountPercent${newId}">%</label>
                            </div>
                            <div class="form-check form-check-lg">
                                <input class="form-check-input discount-type" type="radio" name="discount${newId}" id="discountDollar${newId}">
                                <label class="form-check-label mr-4" for="discountDollar${newId}">$</label>
                            </div>
                        </td>
                        <td style="width:120px;">
                            <input type="text" class="form-control discount-percent" id="form_discount_percent${newId}" inputmode="numeric" pattern="\\d*" title="Please enter a number">
                        </td>
                        <td style="width:120px;">
                            <input type="text" class="form-control discount-dollar" id="form_discount_dollar${newId}" inputmode="numeric" pattern="\\d*" title="Please enter a number">
                        </td>
                        <td style="width:160px;">
                ...
                // Close modal
                $("#fire-modal-add-service").modal("hide");
            });
        // [add_service---------------------------------------------------]
